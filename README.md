...
- **Memory options**: default `mem-zswap` (tmpfiles.d config, no custom service needed); `mem-zram` (zram-generator) as alternative; remove the module for no swap at all — the two are mutually exclusive
